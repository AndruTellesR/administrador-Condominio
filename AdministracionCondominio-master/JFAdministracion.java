...
public class JFAdministracion extends JFrame implements ActionListener
{
   ...
   JCheckBox checkProntop,checkPlataforma;
    ...
    public JFAdministracion() {
        ...
        checkProntop= new JCheckBox("Pronto Pago", false);
        checkPlataforma= new JCheckBox("Pago por plataforma", false);
    ...
    public void actionPerformed(ActionEvent evento){
       ...
       if (checkProntop.isSelected()==true){
